    ...
    rbusMethodAsyncHandle_t asyncHandle)
{
    ...
    {
        WalInfo("Initial notification setup in progress. Rejecting cloud request temporarily.\n");
        rbusValue_SetString(message, "Initial notification setup in progress. Please retry later.");
